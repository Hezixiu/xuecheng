...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "E:\\JAVAServer\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "C:\\Users\\Linzkr\\Videos\\Captures\\RedDead.mp4";
    String mp4_name = "test1.mp4";
    String mp4folder_path = "C:\\Users\\Linzkr\\Videos\\Captures";
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String ffmpeg_path = "E:\\JAVAServer\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "C:\\Users\\Linzkr\\Videos\\Captures\\Original.avi";
        //转换后mp4文件的名称
        String mp4_name = "nacos01.mp4";
        //转换后mp4文件的路径
        String mp4_path = "C:\\Users\\Linzkr\\Videos\\Captures\\nacos01.mp4";
        //创建工具类对象
